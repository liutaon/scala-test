...
public class Outlines {
	public static void main(String[] args) throws IOException {
		...
		System.out
				.println("outline4.xls written.  Two groups.  Collapsed then inner group expanded.");
		...
		System.out
				.println("outline6.xls written.  Two groups with matching end points.  Second group collapsed.");
		...
		System.out
				.println("outline10.xls written.  Row outlines.  Collapsed then inner group expanded.");
		...
		System.out
				.println("outline12.xls written.  Row outlines.  Two row groups with matching end points.  Second group collapsed.");
